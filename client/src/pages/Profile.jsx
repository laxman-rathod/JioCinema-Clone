...
const Profile = () => {
  ...
  return (
    <div>
      <div className="w-[30%] h-full absolute right-0 top-[4.5rem] z-50 px-4  pt-16 pb-4 bg-darkBg font-poppins">
        <div className="flex flex-col items-center pb-4 rounded-xl w-full h-auto bg-profileBackground text-white">
          ...
          <h1 className="relative -top-4 font-extrabold text-lg">Guest</h1>
          {user.success ? (
            <LoggedIn />
          ) : (
            <button
        ...
        <div className="w-full flex items-center justify-between text-white pt-4 pb-3 border-b border-lightish">
          <h3 className="text-sm font-extrabold hover:text-pink cursor-pointer">
            Subscribe Now
          </h3>
        ...
        <div className="w-full flex items-center justify-between font-extrabold text-white pt-4 pb-3 border-b border-lightish">
          <h3 className="text-sm cursor-pointer">Help & Legal</h3>
